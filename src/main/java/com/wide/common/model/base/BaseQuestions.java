...
public abstract class BaseQuestions<M extends BaseQuestions<M>> extends Model<M> implements IBean {
	...
	public void setContant(byte[] contant) {
		set("contant", contant);
	}

	public byte[] getContant() {
		return get("contant");
	}

	public void setExtensiontype(java.lang.Integer extensiontype) {
		set("extensiontype", extensiontype);
	}

	public java.lang.Integer getExtensiontype() {
	...
	public void setHeadertype(java.lang.Integer headertype) {
		set("headertype", headertype);
	}

	public java.lang.Integer getHeadertype() {
