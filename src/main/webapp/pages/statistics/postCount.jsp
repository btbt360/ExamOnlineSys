			...
			<div class="block" style="border: 0px;">
				<div class="block-content collapse in">
					<ul class="nav nav-tabs">
						<li class="active"><a href="＃">考试成绩按岗位统计</a></li>
					</ul>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        Morris.Bar({
            element: 'hero-bar',
            data: [
                {department: '钳工', qualified: 35,noqualified:5,excellent:15},
                {department: '焊工', qualified: 20,noqualified:20,excellent:8},
                {department: '水电工', qualified: 30,noqualified:10,excellent:21},
                {department: '机电工', qualified: 25,noqualified:15,excellent:17},
                {department: '操作工', qualified: 36,noqualified:5,excellent:23},
                {department: '技术工', qualified: 23,noqualified:17,excellent:13},
                {department: '其它工', qualified: 29,noqualified:11,excellent:11}
            ],
            xkey: 'department',
