	...
	<div class="navbar navbar-inner block-header">
		<div class="muted pull-left">
			<ul class="breadcrumb">
				...
				<li><a href="#">我的模拟考试</a> <span class="divider">/</span></li>
				<li class="active">模拟考试管理</li>
			</ul>
		</div>
	</div>
	<div class="row-fluid">
		<div class="block" style="border: 0px;">
			<div class="block-content collapse in">
				<ul class="nav nav-tabs">
					<li class="active"><a href="${basepath}/simulation/addExercise">模拟考试列表</a></li>
					<li><a href="${basepath}/simulation/addExerciseInfo">模拟考试添加</a></li>
				</ul>
				...
				<form action="${basepath}/simulation/exportSubject" method="post"
					id="subform">
					<div class="span12 text-center">
						<div class="span3">
							<label class="control-label" for="name">模拟考试名称：<input
...
<script type="text/javascript">
	function edit(ids) {
		location.href = "${basepath}/simulation/addExerciseInfo?id=" + ids;
	}

	function del(ids) {
		if (confirm("确定要删除该模拟考试？")) {
			$.ajax({
				type : 'post',
				url : '${basepath}/simulation/delExercise?id=' + ids,
				cache : false,
				dataType : 'json',
	...
	$(document).ready(
			function() {
				...
				oTable = $('#userList').initDT({
					serverSide : true,
					"sAjaxSource" : "${basepath}/simulation/getExerciselist"
				});
	...
	function startExercise(exerciseid) {
		...
		tempwindow.location = "${basepath}/simulation/startExercise?exerciseid="
				+ exerciseid;
	}
</script>
