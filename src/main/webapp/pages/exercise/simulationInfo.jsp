...
<c:import url="/pages/include/pageNavigation.jsp" />
	<div class="block" >
		...
		<ul class="nav nav-tabs">
			<li><a href="${basepath}/simulation/addExercise">模拟考试管理列表</a></li>
			<li class="active"><a href="${basepath}/simulation/addExerciseinfo">模拟考试管理添加</a></li>
		</ul>
			<div class="span12">
				...
				<form id="subinfoform" class="form-horizontal" action="${basepath}/simulation/saveExercise" method="post">
					<fieldset>
						<legend>模拟考试管理</legend>
						<div class="control-group">
							<label class="control-label">模拟考试名称：</label>
							<div class="controls">
							<input name="exercise.id" type="hidden" value="${exercise.id}" >
								<input class="input-xlarge focused" id="name" name="exercise.name"
									type="text" placeholder="请输入模拟考试名称!" value="${exercise.name}" >
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">模拟题总数：</label>
							<div class="controls">
						...
						<div class="form-actions">
							...
							<input type="button" value="取消" class="btn"
								onclick="javascript:window.location.href='${basepath}/simulation/addExercise'">
						</div>
					</fieldset>
				</form>
